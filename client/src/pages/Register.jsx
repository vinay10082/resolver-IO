...
const Register = () => {
  ...
  return (
    ...
    <h1 class='font-bold text-center text-3xl mb-6'>Register</h1>
    <form onSubmit={handleSubmit}>
    <div class="mb-6">

      <div class="mb-6">
    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="username">User Name</label>
    ...
    <p>Already have an account ? <Link class="font-bold text-xl" to="/login">login</Link></p>
    </div>
  )
}
